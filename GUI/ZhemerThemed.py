...
class Zhemer:
    ...
    def create_widgets(self):
        ...
        self.palette_scrollbar = ttk.Scrollbar(self.palette_frame, orient="horizontal", command=self.palette_canvas.xview)
        ...
        self.theme_scrollbar = ttk.Scrollbar(self.theme_frame, orient="vertical", command=self.theme_canvas.yview)
        self.theme_canvas.configure(yscrollcommand=self.theme_scrollbar.set)
        self.add_scrollbar_events_y(self.theme_canvas)

        self.theme_inner_frame = ttk.Frame(self.theme_canvas)
        ...
        self.load_button = ttk.Button(self.button_frame, text="Load Theme", command=self.load_theme)
        self.load_button.pack(side="left", padx=5)

        self.save_button = ttk.Button(self.button_frame, text="Save Theme", command=self.save_theme)
        self.save_button.pack(side="left", padx=5)

        self.clear_theme_button = ttk.Button(self.button_frame, text="Clear Theme Colors", command=self.clear_colors)
        ...
        self.clear_palette_button = ttk.Button(self.button_frame, text="Clear Palette", command=self.clear_palette)
        self.clear_palette_button.pack(side="left", padx=5)

        self.load_palette_button = ttk.Button(self.button_frame, text="Load Palette", command=self.load_palette)
    ...
    def update_theme_display(self):
        ...
        for key, value in style.items():
            color_frame = ttk.Frame(self.theme_inner_frame)
    ...
    def open_palette_window(self, set_color_callback):
        ...
        scrollbar = ttk.Scrollbar(palette_window, orient="vertical", command=canvas.yview)
